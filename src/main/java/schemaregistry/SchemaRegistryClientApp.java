...
public class SchemaRegistryClientApp {
    private static final Logger LOG = LoggerFactory.getLogger(SchemaRegistryClientApp.class);
    public static final String DEFAULT_SCHEMA_REG_URL = "http://localhost:9090/api/v1";
    private final Map<String, Object> config;
    private final SchemaRegistryClient schemaRegistryClient;

    public SchemaRegistryClientApp() {
        this(createConfig(DEFAULT_SCHEMA_REG_URL));
    }

    public SchemaRegistryClientApp(Map<String, Object> config) {
        this.config = config;
    ...
    public void runAvroSerDesApis() throws IOException {
        ...
        Object deviceObject = createGenericRecordForProduct("/device.avsc");
    ...
    protected Object createGenericRecordForProduct(String schemaFileName) throws IOException {
    ...
    private String getSchema(String schemaFileName) throws IOException {
        InputStream schemaResourceStream = SchemaRegistryClientApp.class.getResourceAsStream(schemaFileName);
    ...
    public void runCustomSerDesApi() throws Exception {
        ...
        InputStream serdesJarInputStream = SchemaRegistryClientApp.class.getResourceAsStream(serdesJarName);
    ...
    public static void main(String[] args) throws Exception {
        ...
        SchemaRegistryClientApp app = new SchemaRegistryClientApp(config);

        app.runSchemaApis();
        app.runCustomSerDesApi();
